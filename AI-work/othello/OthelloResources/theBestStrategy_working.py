...
def generateMoveTree(board10, player, maxDepth):
    ...
    for c in range(len(children)):
        ...
        #different players want different utility, propogate that
        if (topNode['utility'] == None or abs(newNode['utility'] - pieceUtilGoals[player]) < abs(topNode['utility'] - pieceUtilGoals[player])):
